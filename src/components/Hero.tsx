    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 w-full relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col relative z-20">
          ...
          {/* Main Typography */}
          <h1 data-hero-title className="text-[clamp(3rem,8vw,7rem)] font-bold text-[var(--text-primary)] tracking-tighter leading-[0.85] mb-6 lg:mb-8 uppercase">
            TEJAS <br />
            PRAJAPATI
          </h1>
          
          {/* Developer Title */}
          <h2 data-hero-role className="text-[clamp(1rem,2vw,1.25rem)] font-mono tracking-widest text-[var(--text-secondary)] mb-8 lg:mb-10 uppercase">
            FULL-STACK <br className="sm:hidden" /> DEVELOPER
          </h2>

          {/* Description */}
          <p data-hero-description className="text-base sm:text-lg text-[var(--text-muted)] max-w-[500px] mb-12 lg:mb-16 leading-relaxed font-light">
        ...
        <div data-hero-visual className="w-full lg:w-1/2 relative z-10 flex items-center justify-center">
          <ThreeCanvas />
        </div>

        {/* Technical Metadata - Mobile Only */}
        <div data-hero-meta-mobile className="flex lg:hidden w-full flex-col gap-y-2 mt-4 z-20 items-start">
